...
router.get('/users/plant_manager/:manu_line_id', (req, res) => UserHandler.getPlantManagerByManuLineID(req, res));
router.get('/users/manu_lines/:manu_line_id', (req, res) => UserHandler.getUsersByManuLineID(req, res));
